<div class="app-navbar flex-shrink-0">
    ...
    <div class="app-navbar-item ms-1 ms-lg-3">
        <!--begin::Menu- wrapper-->
        <div id="notifTrigger" class="btn btn-icon btn-custom btn-icon-muted btn-active-light btn-active-color-primary w-35px h-35px w-md-40px h-md-40px">
    ...
    <div class="app-navbar-item ms-1 ms-lg-3">
        ...
        <!--begin::Menu-->
        <div id="themeMode" class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-title-gray-700 menu-icon-gray-500 menu-active-bg menu-state-color fw-semibold py-4 fs-base w-150px">
            <!--begin::Menu item-->
    ...
    <div class="app-navbar-item ms-2 ms-lg-3">
        <!--begin::Menu wrapper-->
        <div class="cursor-pointer symbol symbol-35px symbol-md-40px" id="userMenuTrigger">
            <img src="../build/assets/media/avatars/300-3.jpg" alt="{{ auth()->user()->fname }} {{ auth()->user()->lname }}" />
        </div>

        <!--begin::User account menu-->
        <div id="userMenu" class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px">
            <!--begin::Menu item-->
